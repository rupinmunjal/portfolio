...
function SkillChip({name}: {name: string}) {
  ...
  return (
    <motion.div
      ...
      className="skill-badge inline-flex items-center gap-2 rounded-full border border-[#e8e8e8] bg-[#f7f7f7] px-4 py-2 text-sm font-medium text-[#1a1a1a] outfit-font transition-all duration-300 hover:-translate-y-0.5 hover:bg-white"
    >
...
export function Skills() {
  return (
    <section id="skills" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-white">
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  <motion.div
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#d5d5d5] bg-[#fafafa] text-[#777777]"
                  >
